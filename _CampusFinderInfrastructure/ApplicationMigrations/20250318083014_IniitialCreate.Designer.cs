...
namespace _CampusFinderInfrastructure.ApplicationMigrations
{
    ...
    [Migration("20250318083014_IniitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College", b =>
                {
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College_Diploma", b =>
                {
                    b.Property<int>("CollegeID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College_English", b =>
                {
                    b.Property<int>("CollegeID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.Diploma", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.English_Test", b =>
                {
                    b.Property<int>("TestID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.Major", b =>
                {
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.University", b =>
                {
                    b.Property<int>("UniversityID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College", b =>
                {
                    b.HasOne("_CampusFinderCore.Entities.University", "University")
                        .WithMany("Colleges")
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College_Diploma", b =>
                {
                    b.HasOne("_CampusFinderCore.Entities.College", "College")
                        .WithMany("CollegeDiplomas")
                        .HasForeignKey("CollegeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_CampusFinderCore.Entities.Diploma", "Diploma")
                        .WithMany("CollegeDiplomas")
            ...
            modelBuilder.Entity("_CampusFinderCore.Entities.College_English", b =>
                {
                    ...
                    b.HasOne("_CampusFinderCore.Entities.English_Test", "English_Test")
                        .WithMany("CollegeEnglishTests")
